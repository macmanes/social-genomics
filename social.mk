...
hippo: hippo.left.10.fq hippo.right.10.fq hippo.Trinity.fasta

hippo.left.10.fq hippo.right.10.fq: $(WD)/raw_reads/tuco_hippocampus.1.fq $(WD)/raw_reads/tuco_hippocampus.2.fq
...
hippo.Trinity.fasta:  hippo.left.$$TRIM.fq hippo.right.$$TRIM.fq
	for TRIM in 10; do \
